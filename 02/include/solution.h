#ifndef ADVENT_OF_CODE_2022_02_SOLUTION_H_
#define ADVENT_OF_CODE_2022_02_SOLUTION_H_
...
int part1(const std::string &input_file) {
  ...
  return score_own_moves + score_outcomes;
}
...
#endif // ADVENT_OF_CODE_2022_02_SOLUTION_H_
